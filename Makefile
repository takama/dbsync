...
DBSYNC_DST_DOC_INDICES?=""
DBSYNC_DST_DOC_INCLUDE?=""
DBSYNC_DST_DOC_EXCLUDE?=""
DBSYNC_DST_DOC_COLUMNS?=""
...
run: stop container
	docker run --name ${CONTAINER_NAME} -p ${DBSYNC_SERVICE_PORT}:${DBSYNC_SERVICE_PORT} \
		...
		-e "DBSYNC_DST_DOC_INDICES=${DBSYNC_DST_DOC_INDICES}" \
		-e "DBSYNC_DST_DOC_INCLUDE=${DBSYNC_DST_DOC_INCLUDE}" \
		-e "DBSYNC_DST_DOC_EXCLUDE=${DBSYNC_DST_DOC_EXCLUDE}" \
		-e "DBSYNC_DST_DOC_COLUMNS=${DBSYNC_DST_DOC_COLUMNS}" \
